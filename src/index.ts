...
app.post("/bands", async (req: Request, res: Response) => {
    ...
    try {
       ...
       // const name = req.body.name
        ...
        if(!id || !name){ //SE O ID E O NAME FOREM undefined
            res.status(400)
        ...
        await db.raw(`INSERT INTO bands
            VALUES("${id}", "${name}")
        `) //ASPAS PORQUE TEXT PRECISA VIR EM ASPAS// ISSO NÃO RETORNA NDA NÃO É UMA CONSULTA, SÓ VAI INSERIR
...
//Pratica 3 - Atualizando os dados
//:id porque minhas informações vão vir por params
app.put("/bands/:id", async (req: Request, res: Response)=>{
    ...
    try{
        ...
        // conexão com o banco / verificancdo se o id existe
        //[band] desestrutura array
